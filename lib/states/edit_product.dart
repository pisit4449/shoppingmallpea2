...
class _EditProductState extends State<EditProduct> {
        ...
        children: [
          ...
          Container(
            ...
            child: files[index] == null
                ? CachedNetworkImage(
                    imageUrl:
                        '${MyConstant.domain}/shoppingmallnew/${pathImages[index]}',
  ...
  Future<Null> processEdit() async {
    if (formKey.currentState!.validate()) {
      ...
      // String images = pathImages.toString();
      print('### statusImage = $statusImages');
      print('### id = $id , name = $name, price = $price, detail = $detail');
      print('### images = $images');

      String apiEditProduct =
          '${MyConstant.domain}/shoppingmallnew/editProductWhereId.php?isAdd=true&id=$id&name=$name&price=$price&detail=$detail&images=$images';
